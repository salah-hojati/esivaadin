...
INSERT INTO productdb.template (id, content, path, template_name) VALUES (6, 'package com.${project.name?lower_case}.dto;
...
INSERT INTO productdb.template (id, content, path, template_name) VALUES (7, 'package com.${project.name?lower_case}.service.dao;

import com.${project.name?lower_case}.service.dao.BaseDao;
...
@Stateless
@LocalBean
public class ${entity.name}Dao extends BaseDao<${entity.name}> {

}', 'src/main/java/com/${project.name?lower_case}/service/dao/${entity.name}Dao.java', 'entityDao_ejb');
INSERT INTO productdb.template (id, content, path, template_name) VALUES (8, 'package com.${project.name?lower_case}.domain;
...
INSERT INTO productdb.template (id, content, path, template_name) VALUES (9, 'package com.${project.name?lower_case}.service.dao;
...
}', 'src/main/java/com/${project.name?lower_case}/service/dao/BaseDao.java', 'BaseDao');
...
INSERT INTO productdb.template (id, content, path, template_name) VALUES (65, 'package com.${project.name?lower_case}.dto;
...
', 'src/main/java/com/${project.name?lower_case}/dto/ResponseMessageEnum.java', 'ResponseMessageEnum');
